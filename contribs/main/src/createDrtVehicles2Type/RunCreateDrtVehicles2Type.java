...
public class RunCreateDrtVehicles2Type {
	public static void main(String[] args) {
		...
		int numberofVehicles1 = 200;//ride-sharing
		int numberofVehicles2 = 0;//car-sharing
		double operationStartTime = 0.; //t0
		double operationEndTime = 29*3600.;	//t1
		int seats1 = 8;
		int seats2 = 1;
		String networkfile = "/Users/jo/git/matsim/contribs/UT_MATSim/resources/Numata_0824/Network.xml";
		String drtsFile = "/Users/jo/git/matsim/contribs/UT_MATSim/resources/Numata_0824/drts_L"+numberofVehicles1+"_S"+numberofVehicles2+".xml";
