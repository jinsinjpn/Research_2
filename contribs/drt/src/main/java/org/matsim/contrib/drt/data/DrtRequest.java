...
public class DrtRequest /*extends RequestImpl*/ implements PassengerRequest {
	...
	public DrtRequest(Id<Request> id, MobsimPassengerAgent passenger, Link fromLink, Link toLink,
			double earliestStartTime, double latestStartTime, double latestArrivalTime, double submissionTime,//現在departureTime=earliestStartTime
			VrpPathWithTravelData unsharedRidePath) {//earliestStartTime=departureTime
//		super(id, 1, earliestStartTime, latestStartTime, submissionTime);
		...
		this.toLink = toLink;
		this.latestArrivalTime = latestArrivalTime;//double latestArrivalTime = departureTime + maxTravelTime;
	...
	public double getEarliestStartTime() {
		return delegate.getEarliestStartTime();//ここをーにしても前回と同じ結果
	}
