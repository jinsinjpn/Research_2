...
public class TravelTimeCalculator implements LinkEnterEventHandler, LinkLeaveEventHandler,
	...
	public double getLinkTravelTime(final Link link, final double time) {
		if (this.calculateLinkTravelTimes) {
			...
			//System.out.println(this.aggregator);
			//System.out.println(this.aggregator.getTravelTime(data.ttData, time));
			//System.out.println(data.ttData);
...
//			}
	...
	public void reset(int iteration) {
		if (this.calculateLinkTravelTimes) {
			for (DataContainer data : this.linkData.values()){//２回転目以降はここでresetされる
