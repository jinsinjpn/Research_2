	...
	public RoutingModule get() {
		...
		LeastCostPathCalculator routeAlgo =
				leastCostPathCalculatorFactory.createPathCalculator(
						...
						travelTime);
		//System.out.println(travelDisutilityFactory.createTravelDisutility(travelTime));//kamijo//多分はじめのモードごとにこのメソッドを使っている。
		//System.out.println("kkkkkk");
		//System.out.println(routeAlgo);
		//System.out.println(routeAlgo.toString());
