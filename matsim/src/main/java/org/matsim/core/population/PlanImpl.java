...
//	}
	...
	/*
	@Override
	public final Double finalgetScore() {
		//System.out.println(this.score);//
		//System.out.println(this.actsLegs);
		//System.out.println(this.actsLegs.get(0));
		//System.out.println(this.actsLegs.toArray(new String[this.actsLegs.size()]));
		for(int s = 0; s < this.actsLegs.size(); s++) {//全部上条オリジナル
			if(this.actsLegs.get(s) instanceof Leg) {//LEG型か否か
				Leg leg = (Leg)this.actsLegs.get(s);
				if(leg.getMode()=="car"&&this.score!=null) {
					this.score -= 1000;//ここの数値の五倍が反映される
					break;
				}
