...
public final class PersonUtils {
	...
	private static final String BICYCLE_AVAIL = "bicycAvail";
	...
	public static String getBicycAvail(Person person) {
		return (String) person.getAttributes().getAttribute(BICYCLE_AVAIL);
		}
	...
	public static void setBicycAvail(Person person, final String bicycAvail) {//KAMIJO
		if (bicycAvail!=null){
		person.getCustomAttributes().put(BICYCLE_AVAIL, bicycAvail);
		person.getAttributes().putAttribute(BICYCLE_AVAIL,bicycAvail ) ;
		}
	}
	/**
	 * convenience method for often used demographic attribute
