...
/* deliberately package */ class PopulationReaderMatsimV5 extends MatsimXmlParser implements MatsimReader {
	...
	private final static String ATTR_PERSON_BICYCLEAVAIL = "bicyc_avail";//KAMIJO
...
//		int age = Integer.MIN_VALUE;
		...
		PersonUtils.setBicycAvail(this.currperson, atts.getValue(ATTR_PERSON_BICYCLEAVAIL));//KAMIJO
